...
<div className="grid lg:grid-cols-2 gap-6">
            <div className="glass-card rounded-xl p-6 animate-in">
              ...
              <div
                ...
                className={`border-2 border-dashed rounded-xl p-8 text-center transition-all cursor-pointer
                  ...
                  hover:border-accent-500/30 hover:shadow-lg hover:shadow-accent-600/5`}
              ...
              <div className="mt-4 flex gap-3">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 py-3 rounded-lg bg-gradient-to-r from-accent-600 to-accent-500 hover:from-accent-500 hover:to-accent-400 disabled:from-navy-700 disabled:to-navy-700 disabled:text-navy-400 text-white font-semibold transition-all hover:shadow-lg hover:shadow-accent-600/25 hover:-translate-y-0.5 active:translate-y-0 btn-primary"
                >
                ...
                <button
                  onClick={runDemo}
                  disabled={analyzing}
                  className="flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-navy-800/50 border border-navy-700/30 hover:border-accent-500/30 hover:bg-navy-700/50 text-white font-medium transition-all disabled:text-navy-400 btn-secondary"
                >
                  ...
                  <div key={i} className="flex items-center gap-3">
                    ...
                    {stage.status === 'processing' && (
                      <div className="flex-1 h-1.5 bg-navy-800 rounded-full overflow-hidden ml-2">
                        <div className="h-full bg-gradient-to-r from-accent-500 to-accent-400 rounded-full animate-pulse" style={{ width: '70%' }} />
                      </div>
                    )}
                  </div>
                ))}
              ...
              {result && (
                <div className="mt-6 pt-4 border-t border-navy-700/30">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="glass-card-sm rounded-lg p-3">
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    ...
                    <Link
                      to="/map"
                      className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-gradient-to-r from-accent-600 to-accent-500 hover:from-accent-500 hover:to-accent-400 text-white text-xs font-semibold shadow-lg shadow-accent-600/20 transition-all btn-primary"
                    >
                      View on GIS Map
          ...
          <div className="mt-6 glass-card rounded-xl p-6 animate-in delay-300">
            ...
            <div className="flex flex-wrap items-center gap-2 text-sm">
              {[
                ...
                <div key={i} className="flex items-center gap-2">
                  <span className="px-3 py-1.5 rounded-lg bg-navy-800/50 border border-navy-700/30 text-xs hover:border-accent-500/30 hover:bg-navy-700/50 transition-all">
                    {step}
                  </span>
